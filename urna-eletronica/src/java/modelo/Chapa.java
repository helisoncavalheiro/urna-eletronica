...
public class Chapa implements Serializable {
    ...
    @JoinTable(name = "voto", joinColumns = {
        @JoinColumn(name = "id_chapa", referencedColumnName = "id_chapa")}, inverseJoinColumns = {
    ...
    public List<Urna> getUrnaList() {
        return urnaList;
    }

    public void setUrnaList(List<Urna> urnaList) {
        this.urnaList = urnaList;
    }
